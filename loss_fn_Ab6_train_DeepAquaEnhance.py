...
# ablation study; loss fn : a=5, b=7

# print("Importing Libraries")
%cd /home/gan_mula/MuLA_GAN-main/ 
...
checkpoint_dir = os.path.join("ab6/", dataset_name)
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "ab6/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "ab6/%s/discriminator_%d.pth" % (dataset_name, epoch))
