#ablation study 13:  loss fn :  loss_1  : a=3
...
checkpoint_dir = os.path.join("ab13/", dataset_name)
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "ab13/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "ab13/%s/discriminator_%d.pth" % (dataset_name, epoch))
