...
# ablation study, loss_fn : a=9, b=3
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "ab7/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "ab7/%s/discriminator_%d.pth" % (dataset_name, epoch))
