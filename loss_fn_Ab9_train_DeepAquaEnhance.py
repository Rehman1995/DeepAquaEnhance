#ablation study 9:  loss fn :  loss_1+ loss_c : a=3, b=1
...
checkpoint_dir = os.path.join("ab9/", dataset_name)
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "ab9/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "ab9/%s/discriminator_%d.pth" % (dataset_name, epoch))
