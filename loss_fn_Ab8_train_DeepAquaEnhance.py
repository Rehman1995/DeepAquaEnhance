#ablation study 8:  loss fn :  loss_1+ loss_c : a=7, b=9
...
checkpoint_dir = os.path.join("ab8/", dataset_name)
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "ab8/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "ab8/%s/discriminator_%d.pth" % (dataset_name, epoch))
