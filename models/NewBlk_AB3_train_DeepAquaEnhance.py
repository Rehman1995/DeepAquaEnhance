...
# block ablation study 3:Transblk & MultiMHSA only
...
from models.Newbkab3_MuLA_GAN_Initial_model_1   import MuLA_GAN_Generator, Discriminator
...
checkpoint_dir = os.path.join("Newbkab3/", dataset_name)
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "Newbkab3/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "Newbkab3/%s/discriminator_%d.pth" % (dataset_name, epoch))
