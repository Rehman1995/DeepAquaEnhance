...
# blk ablation study 2: REPLACE MultiMhsa with UNETdown,  loss fn = a*loss_1 + b*loss_con
...
from models.b1ab2_MuLA_GAN_Initial_model_1  import MuLA_GAN_Generator, Discriminator
...
checkpoint_dir = os.path.join("bkab2/", dataset_name)
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "bkab2/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "bkab2/%s/discriminator_%d.pth" % (dataset_name, epoch))
